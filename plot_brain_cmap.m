function h = plot_brain_cmap(surf_hr, surf_lr, vert_inds_lr, data_lr, mask_lr, atlas, brain_opacity)
% DESCRIPTION:
% -----------
...
% ____________________________________________________________
	...
	% ---- Plot masked data ---- % 
	hold on;
	trisurf(faces_hr_, vx_hr, vy_hr, vz_hr, c_hr,  'EdgeColor', 'None', 'FaceAlpha', 1);
